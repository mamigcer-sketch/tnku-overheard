      ...
      <div className={`bg-white/[0.02] backdrop-blur-md border border-white/[0.05] p-4 sm:p-5 rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-all hover:border-white/[0.1] hover:bg-white/[0.04] ${
        ...
        <div className="flex justify-between items-center mb-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className={`w-6 h-6 flex items-center justify-center rounded-md ${hasCustomNick ? 'bg-gradient-to-br from-amber-500/20 to-pink-500/20 border border-pink-500/30 text-pink-400' : `${commentAuthor.gradient} text-[12px]`} shadow-inner`}>
              {hasCustomNick ? (
