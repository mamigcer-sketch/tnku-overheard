      ...
      <div className={`bg-white/[0.02] backdrop-blur-md border border-white/[0.05] p-4 sm:p-5 rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-all hover:border-white/[0.1] hover:bg-white/[0.04] ${
        ...
        <div className="flex justify-between items-center mb-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {/* 🔥 ÖZEL NİCK VE İNSTAGRAM LOGOSU */}
            <span className={`font-bold text-[12px] tracking-wide flex items-center gap-1.5 ${hasCustomNick ? 'text-yellow-50 drop-shadow-sm' : 'text-gray-200'}`}>
              @{commentAuthor.name}
              {hasCustomNick && (
                <span className="flex items-center gap-1 bg-gradient-to-r from-amber-500/20 to-pink-500/20 border border-pink-500/30 px-1.5 py-0.5 rounded text-[9px] text-pink-300 font-bold">
                  {/* Instagram SVG Logosu */}
                  <svg className="w-2.5 h-2.5 text-pink-400 fill-current" viewBox="0 0 24 24">
